...
export const placeholderProducts: Product[] = [
  {
    ...
    variants: [
      ...
      { id: 'v2', name: '延伸板', price: '399 USDT', description: '便携可拆分头部+此功能有口交功能，有发声器发声功能，支持阴交 肛交 乳交 足交 口交+仿真人套发+阴道一体式设计+内置金属骨架+可私人订制智能语音和私处植毛+通道恒温37.5°C+医用级精细纳米软硅胶+1:1真人打造蜡像S妆容+真人仿真果冻胸+可随意调节四肢+产品终身保修+装箱收纳1米' },
    ],
  },
  {
    id: 'p2',
