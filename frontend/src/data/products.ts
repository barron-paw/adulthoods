...
export const placeholderProducts: Product[] = [
  ...
  { id: 'p4', name: '产品4', description: 'Product description placeholder.', images: [`${IMAGE_BASE}/7.png`], videoUrl: `${VIDEO_BASE}/8.MP4?v=8`, defaultVariantId: 'v1', variants: [{ id: 'v1', name: 'Variant A', price: '0.01 BNB' }, { id: 'v2', name: 'Variant B', price: '0.01 BNB' }] },
  ...
  { id: 'p6', name: '产品6', description: 'Product description placeholder.', images: [`${IMAGE_BASE}/11.png`], videoUrl: `${VIDEO_BASE}/12.MP4?v=12`, defaultVariantId: 'v1', variants: [{ id: 'v1', name: 'Variant A', price: '0.01 BNB' }, { id: 'v2', name: 'Variant B', price: '0.01 BNB' }] },
]
