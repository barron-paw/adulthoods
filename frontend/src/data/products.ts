...
export const placeholderProducts: Product[] = [
  ...
  },
  {
    id: 'p4',
    name: '产品4',
    description: '杰士邦全新升级款暴风姬pro飞机杯，40mm超长伸缩，6种全自动伸缩+12种震动模式，多频伸缩和可调节的节奏任您选择。',
    images: [`${IMAGE_BASE}/7.png`],
    videoUrl: `${VIDEO_BASE}/8.MP4?v=8`,
    defaultVariantId: 'v1',
    variants: [{ id: 'v1', name: '标准款', price: '99 USDT', description: '杰士邦全新升级款暴风姬pro飞机杯，40mm超长伸缩，6种全自动伸缩+12种震动模式，多频伸缩和可调节的节奏任您选择。' }],
  },
  {
    id: 'p5',
    name: '产品5',
    description: '全自动假阳具自慰器女性自动抽插情趣用品高潮成人玩具假阴茎炮机。',
    images: [`${IMAGE_BASE}/9.png`],
    videoUrl: `${VIDEO_BASE}/10.MP4?v=10`,
    defaultVariantId: 'v1',
    variants: [{ id: 'v1', name: '标准款', price: '199 USDT', description: '全自动假阳具自慰器女性自动抽插情趣用品高潮成人玩具假阴茎炮机。' }],
  },
  {
    id: 'p6',
    name: '产品6',
    description: '震动av棒女用品专用玩具自慰器成人情趣按摩振动高潮神器电动强震。',
    images: [`${IMAGE_BASE}/11.png`],
    videoUrl: `${VIDEO_BASE}/12.MP4?v=12`,
    defaultVariantId: 'v1',
    variants: [{ id: 'v1', name: '标准款', price: '99 USDT', description: '震动av棒女用品专用玩具自慰器成人情趣按摩振动高潮神器电动强震。' }],
  },
]
