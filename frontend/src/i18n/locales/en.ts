export const en = {
  ...
  product: {
    ...
    verify: 'Verify',
    verifyAmountHint: 'Payment amount must be ≥ product price to pass verification.',
    images: 'Images',
    video: 'Video',
  ...
  p3OptionNames: {
    ...
    hip: 'Vibrating hip',
    thigh: 'Thigh split',
    vessel: 'Meridian & vessels',
    heat: 'Full-body heating',
    clamp: 'Lower body clamp & suction',
    finger: 'Finger bones',
    deep: 'Deep throat oral',
    nod: 'Nodding oral',
    waist: 'Waist twist',
    hair: 'Hair implant',
  },
