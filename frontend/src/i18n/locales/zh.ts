...
export const zh = {
  ...
  product: {
    ...
    verify: '验证',
    verifyAmountHint: '支付金额须 ≥ 所选商品价格方可验证通过。',
    images: '图片',
    video: '视频',
...
可选择 Sex Doll 外貌定制，例如选择某位明星脸/身材，私人订制专属外观。
...
手工植入头发、眉毛和眼睫毛，更美丽动人。`,
    ...
    p4: { v1: '杰士邦全新升级款暴风姬pro飞机杯，40mm超长伸缩，6种全自动伸缩+12种震动模式，多频伸缩和可调节的节奏任您选择。', v2: '' },
    p5: { v1: '全自动假阳具自慰器女性自动抽插情趣用品高潮成人玩具假阴茎炮机。', v2: '' },
    p6: { v1: '震动av棒女用品专用玩具自慰器成人情趣按摩振动高潮神器电动强震。', v2: '' },
  },
